...
{
    public class MainDialogAuth : LogoutDialog
    {
        protected readonly ILogger Logger;

        public MainDialogAuth(IConfiguration configuration, ILogger<MainDialog> logger)
        ...
        private async Task<DialogTurnResult> LoginStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                //await stepContext.Context.SendActivityAsync(MessageFactory.Text("You have been successfully logged in"), cancellationToken);
