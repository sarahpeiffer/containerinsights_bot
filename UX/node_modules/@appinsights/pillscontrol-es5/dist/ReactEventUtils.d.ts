...
export declare class ReactEventUtils {
     ...
     */
    static appendHandler<T>(existingEventHandler: React.MouseEventHandler<T>, newEventHandler: React.MouseEventHandler<T>): React.MouseEventHandler<T>;
    static appendKeyHandler<T>(existingEventHandler: React.KeyboardEventHandler<T>, newEventHandler: React.KeyboardEventHandler<T>): React.KeyboardEventHandler<T>;
}
