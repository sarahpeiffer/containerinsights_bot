		...
		value: function render() {
			...
			return option.disabled ? React.createElement(
				...
				{ className: className,
					...
					title: option.title },
				this.props.showCheckbox ? React.createElement(
					'div',
					{ className: 'value-with-check' },
					React.createElement('input', { type: 'checkbox', id: instancePrefix + '-checkbox-' + optionIndex, title: option.title, tabIndex: -1, onChange: this.onCheckboxClick, checked: !!(this.props.isSelected || option.isSelected) }),
					React.createElement(
						'div',
						{ className: 'value' },
						this.props.children
		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			if (this.props.disabled || !this.props.searchable) {
				...
				return React.createElement(
					...
					React.createElement('input', { disabled: true, type: 'text', tabIndex: -1, 'aria-label': this.props['aria-label'] || this.props.placeholder })
				);
			}
