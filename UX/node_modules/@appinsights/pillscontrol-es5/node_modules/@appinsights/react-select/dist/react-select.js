		...
		value: function render() {
			...
			return option.disabled ? React__default.createElement(
				...
				{ className: className,
					...
					title: option.title },
				this.props.showCheckbox ? React__default.createElement(
					'div',
					{ className: 'value-with-check' },
					React__default.createElement('input', { type: 'checkbox', id: instancePrefix + '-checkbox-' + optionIndex, title: option.title, tabIndex: -1, onChange: this.onCheckboxClick, checked: !!(this.props.isSelected || option.isSelected) }),
					React__default.createElement(
						'div',
						{ className: 'value' },
						this.props.children
...
Option.propTypes = {
	...
	showCheckbox: PropTypes.bool // whether should show checkbox by option or not
};
...
var Select$1 = function (_React$Component) {
	...
	createClass(Select, [{
		...
		value: function componentDidUpdate(prevProps, prevState) {
			// focus to the selected option - do it except if using checkboxes, which shouldn't scroll down to preserve user position
			if (this.menu && this.focused && this.state.isOpen && !this.hasScrolledToOption && !this.props.showCheckbox) {
			...
			if (prevState.isOpen !== this.state.isOpen) {
				...
				this.setState({ showActiveDescendant: false });
		...
		value: function toggleTouchOutsideEvent(enabled) {
			if (enabled) {
				...
				document.addEventListener('click', this.handleTouchOutside, true);
			} else {
				...
				document.removeEventListener('click', this.handleTouchOutside, true);
			}
		}
	}, {
		...
		value: function handleInputBlur(event) {
			...
			if (this.props.onBlur) {
				isOpen = !!this.props.onBlur(event);
			}
			var onBlurredState = {
				isFocused: false,
				isOpen: isOpen,
   ...
   */
		...
		value: function selectValue(value) {
			...
			if (this.props.closeOnSelect) {
				this.hasScrolledToOption = !this.props.showCheckbox;
			}
		...
		value: function addValue(value) {
			...
			// Showing checkbox doesn't warrant changing focus option (keep user state sane)
		...
		value: function renderValue(valueArray, isOpen) {
			...
			if (this.props.multi && this.props.showTags) {
				return valueArray.map(function (value, i) {
					return React__default.createElement(
						ValueComponent,
						{
							...
							onClick: onClick,
							onRemove: _this5.props.showTags ? _this5.removeValue : undefined,
				...
				// Multi-select with summary (X selected)
			} else if (this.props.multi && !this.state.inputValue) {
				if (isOpen) onClick = null;
				var displayedValue = '{0} selected'.replace('{0}', valueArray.length);

				if (valueArray && valueArray.length === 1) {
					displayedValue = renderLabel(valueArray[0]);
				} else if (this.props.options && this.props.options.length > 0) {
					displayedValue = '{0} of {1} selected'.replace('{0}', valueArray.length).replace('{1}', this.props.options.length);
				}
		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			if (isOpen && this.state.showActiveDescendant) {
				activeDescendant = this._instancePrefix + '-option-' + focusedOptionIndex;
			} else if (!isOpen) {
				activeDescendant = this._instancePrefix + '-value';
			}
			...
			if (this.props.disabled || !this.props.searchable) {
				...
				return React__default.createElement(
					...
					React__default.createElement('input', { disabled: true, type: 'text', tabIndex: -1, 'aria-label': this.props['aria-label'] || this.props.placeholder })
				);
			}
		...
		value: function render() {
			...
			var valueArray = this.getValueArray(this.props.value);
			var options = this._visibleOptions = this.filterOptions(this.props.multi && this.props.removeSelected && !this.props.showCheckbox ? valueArray : null);
			var isOpen = this.state.isOpen;
			...
			var className = classNames('Select', this.props.className, {
				...
				'Select--multi': this.props.multi && this.props.showTags,
				'Select--rtl': this.props.rtl,
				'Select--single': !this.props.multi || this.props.multi && !this.props.showTags
			});
			...
			return React__default.createElement(
				...
				React__default.createElement(
					...
					React__default.createElement(
						'span',
						{ className: 'Select-multi-value-wrapper', id: this._instancePrefix + '-value', tabIndex: '-1', role: 'presentation' },
				...
				isOpen || this.props.shouldAlwaysBeOpen ? this.renderOuter(options, valueArray, focusedOption) : null
			);
		}
	}]);
	return Select;
...
Select$1.propTypes = {
	...
	shouldAlwaysBeOpen: PropTypes.bool, // Whether the dropdowns should always be expanded or not.
	showCheckbox: PropTypes.bool, // Shows checkboxes in multi-select dropdown if true. Also causes options to not disappear if selected.
	showTags: PropTypes.bool, // Shows tags if true, "X selected" if false
