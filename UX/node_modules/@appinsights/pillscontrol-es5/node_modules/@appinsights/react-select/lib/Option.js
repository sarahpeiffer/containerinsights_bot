		...
		value: function render() {
			...
			return option.disabled ? _react2.default.createElement(
				...
				{ className: className,
					...
					title: option.title },
				this.props.showCheckbox ? _react2.default.createElement(
					'div',
					{ className: 'value-with-check' },
					_react2.default.createElement('input', { type: 'checkbox', id: instancePrefix + '-checkbox-' + optionIndex, title: option.title, tabIndex: -1, onChange: this.onCheckboxClick, checked: !!(this.props.isSelected || option.isSelected) }),
					_react2.default.createElement(
						'div',
						{ className: 'value' },
						this.props.children
...
Option.propTypes = {
	...
	showCheckbox: _propTypes2.default.bool // whether should show checkbox by option or not
};
