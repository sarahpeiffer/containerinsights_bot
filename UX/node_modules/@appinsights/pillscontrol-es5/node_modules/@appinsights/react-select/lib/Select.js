		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			if (this.props.disabled || !this.props.searchable) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { disabled: true, type: 'text', tabIndex: -1, 'aria-label': this.props['aria-label'] || this.props.placeholder })
				);
			}
...
Select.propTypes = {
	...
	shouldAlwaysBeOpen: _propTypes2.default.bool, // Whether the dropdowns should always be expanded or not.
	showCheckbox: _propTypes2.default.bool, // Shows checkboxes in multi-select dropdown if true. Also causes options to not disappear if selected.
	showTags: _propTypes2.default.bool, // Shows tags if true, "X selected" if false
