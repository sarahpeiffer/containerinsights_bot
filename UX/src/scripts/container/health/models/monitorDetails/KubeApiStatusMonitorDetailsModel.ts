...
/** local */
import { IKubeApiStatusDetails } from '../../viewmodels/monitorDetails/MonitorDetailsTypings';
import { HealthState } from '../../HealthState';

/**
 * Model for Kube API status monitor details component
 */
export class KubeApiStatusMonitorDetailsModel {
    /** monitor details */
    private _details: IKubeApiStatusDetails;
     ...
     */
    public get details(): IKubeApiStatusDetails {
        return this._details;
    }

    /** sets details in the model */
    public set details(details: IKubeApiStatusDetails) {
        this._details = details;
    }
