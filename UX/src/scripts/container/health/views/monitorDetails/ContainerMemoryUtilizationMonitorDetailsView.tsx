...
import { 
    ContainerMemoryUtilizationMonitorDetailsViewModel, IContainerMemoryDetailsMonitorAccordionItemData 
} from '../../viewmodels/monitorDetails/ContainerMemoryUtilizationMonitorDetailsViewModel';
import { ChevronUpSvg } from '../../../../shared/svg/chevron-up';
import { ChevronDownSvg } from '../../../../shared/svg/chevron-down';
import { HealthState } from '../../HealthState';

/** Container memory monitor details view component */
export class ContainerMemoryUtilizationMonitorDetailsView extends HealthMonitorDetailsViewBase {
    /**
    ...
    protected renderMonitorDetails(): JSX.Element { 
        const context = this.state.context as ContainerMemoryUtilizationMonitorDetailsViewModel;
    ...
    protected createViewModel(parentContext: HealthMonitorDetailsContainerViewModel): IHealthMonitorDetailsViewModel { 
        return new ContainerMemoryUtilizationMonitorDetailsViewModel(
    ...
    private generateAccordionItems(): AccordionItem[] {
        ...
        const accordionItemsData: IContainerMemoryDetailsMonitorAccordionItemData[] = context.getAccordionItemsData();

        const accordionItems: AccordionItem[] = accordionItemsData.map(
            (accordionItemData: IContainerMemoryDetailsMonitorAccordionItemData, index: number) => {
