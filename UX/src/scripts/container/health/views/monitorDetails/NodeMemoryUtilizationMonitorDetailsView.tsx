...
/** local */
import { 
    NodeMemoryUtilizationMonitorDetailsViewModel 
} from '../../viewmodels/monitorDetails/NodeMemoryUtilizationMonitorDetailsViewModel';
...
/** Node memory monitor details view component */
export class NodeMemoryUtilizationMonitorDetailsView extends HealthMonitorDetailsViewBase {
    /**
    ...
    /** protected render method */
    protected renderMonitorDetails(): JSX.Element {
        const context = this.state.context as NodeMemoryUtilizationMonitorDetailsViewModel;

        // Adjust the height of the sg-container div to fit the sg as desired
        const sgBoxSizeCalculator = {
            height: ((context.convertModelNodeMemoryDetailsIntoSGDataRows().length + 1) * SGDataRowHeight) + 5 + 'px',
        }
            ...
            <div className='property-panel-content'>
                ...
                <div className='sg-container' style={sgBoxSizeCalculator}>
                    <SelectableGrid
                        ...
                        data={context.convertModelNodeMemoryDetailsIntoSGDataRows()}
                    />
                </div>
            </div>
        );
    ...
    protected createViewModel(parentContext: HealthMonitorDetailsContainerViewModel): IHealthMonitorDetailsViewModel {   
        return new NodeMemoryUtilizationMonitorDetailsViewModel(
    ...
    private getColumnDefinitions(sortColumn: number, sortOrder: number): SGColumn[] {
        ...
        columnDefinitions.push({
            name: DisplayStrings.NodeMemoryUtilGridTimestampColumnTitle,
        ...
        columnDefinitions.push({
            name: DisplayStrings.NodeMemoryUtilGridStatusColumnTitle,
            width: 0,
            cell: SGIconCell(
                (data: string) => data, 
            ...
            sortable: false,
            infoText: DisplayStrings.NodeMemoryUtilGridStatusColumnTooltip
        });
        ...
        columnDefinitions.push({
            ...
            sortable: false,
            infoText: DisplayStrings.NodeMemoryUtilGridMemoryUsageColumnTooltip
        });
